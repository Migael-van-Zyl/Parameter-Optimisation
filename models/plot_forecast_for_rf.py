...
output_folder = Path(
    r"C:\Users\MauduH\OneDrive - Eskom Holdings SOC Ltd\Python Projects\Parameter-Optimisation\results\forecast_plots_rf"
)
...
for customer in customers:
    ...
    plt.plot(test.index, forecast, label="Random Forest Forecast")

    plt.title(
        f"Random Forest Forecast | Customer {customer}\n"
        f"{category} - {subsic} | "
    ...
    save_path = output_folder / f"{subsic}_customer_{customer}_rf_forecast.png"
